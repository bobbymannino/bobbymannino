...
[Digital Ocean Droplets](https://www.digitalocean.com/products/droplets). They
seemed to solve all the issues I was having. A Virtual Private Server (VPS) is
essentially a computer that you have access to, but it is stored elsewhere (like
cloud storage). You can then access the computer via ssh and do with it as you
please. Depending on the provider you can have a linux OS or a window OS -
usually costing a bit more for windows.
